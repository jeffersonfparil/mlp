...
ROOT_OUTDIR = "path/to/tmp"
SCRIPTS_DIR = "path/to/mlp/tests/scripts"
...
TRIALS_OUTPUT = expand(
    "{ROOT_OUTDIR}/{DATA_TYPES}/input_simulated-YEARS_${N_YEARS}-SITES_${N_SITES}-TREATMENTS_${N_TREATMENTS}-ENTRIES_${N_ENTRIES}-REPLICATIONS_${N_REPLICATIONS}-HIDDEN_LAYERS_${N_HIDDEN_LAYERS}.tsv",
