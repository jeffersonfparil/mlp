...
mod tests {
    ...
    fn test_marginal() -> Result<(), Box<dyn Error>> {
        ...
        marginals.effects.iter().zip(vec![0.9285408, 0.9200818, 0.9217339, 0.9266311, 0.92468035, 0.9166402, 0.9205366].iter()).for_each(|(a, b)| {assert_relative_eq!(a, b, epsilon=1.0e-6)});
